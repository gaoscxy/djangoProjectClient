...
public class CollBookBean implements Parcelable{
    ...
    public String getTitle() {
        return StringUtils.convertCC(title, MyApplication.getContext());
    }
    ...
    public String getAuthor() {
        return StringUtils.convertCC(author, MyApplication.getContext());
    }
    ...
    public String getShortIntro() {
        return StringUtils.convertCC(shortIntro, MyApplication.getContext());
    }
    ...
    public String getCover() {
        return StringUtils.convertCC(cover, MyApplication.getContext());
    }
    ...
    public String getUpdated() {
        return StringUtils.convertCC(updated, MyApplication.getContext());
    }
    ...
    public String getLastChapter() {
        return StringUtils.convertCC(lastChapter, MyApplication.getContext());
    }
    ...
    public String getLastRead() {
        return StringUtils.convertCC(lastRead, MyApplication.getContext());
    }
...
//        }
    ...
    public List<BookChapterBean> getBookChapterList() {
        if (bookChapterList == null) {
            ...
            List<BookChapterBean> bookChapterListNew = targetDao
                    ._queryCollBookBean_BookChapterList(bookinfo_id);
            synchronized (this) {
                if (bookChapterList == null) {
    ...
    @Generated(hash = 1118773230)
    public CollBookBean(String _id, int bookinfo_id, String title, String author, String shortIntro,
            String cover, boolean hasCp, int latelyFollower, double retentionRatio, String updated,
