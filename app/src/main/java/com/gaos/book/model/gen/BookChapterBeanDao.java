package com.gaos.book.model.gen;
...
public class BookChapterBeanDao extends AbstractDao<BookChapterBean, String> {
    ...
    public static class Properties {
        ...
        public final static Property Chapter_path = new Property(1, String.class, "chapter_path", false, "CHAPTER_PATH");
        ...
        public final static Property Bookinfo_id = new Property(5, int.class, "bookinfo_id", false, "BOOKINFO_ID");
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"BOOK_CHAPTER_BEAN\" (" + //
                ...
                "\"CHAPTER_PATH\" TEXT," + // 1: chapter_path
                "\"CHAPTER_NAME\" TEXT," + // 2: chapter_name
                "\"TASK_NAME\" TEXT," + // 3: taskName
                "\"UNREADBLE\" INTEGER NOT NULL ," + // 4: unreadble
                "\"BOOKINFO_ID\" INTEGER NOT NULL ," + // 5: bookinfo_id
                "\"START\" INTEGER NOT NULL ," + // 6: start
                "\"END\" INTEGER NOT NULL );"); // 7: end
        // Add Indexes
        db.execSQL("CREATE INDEX " + constraint + "IDX_BOOK_CHAPTER_BEAN_BOOKINFO_ID ON \"BOOK_CHAPTER_BEAN\"" +
                " (\"BOOKINFO_ID\" ASC);");
    }
    ...
    protected final void bindValues(DatabaseStatement stmt, BookChapterBean entity) {
        ...
        String chapter_path = entity.getChapter_path();
        if (chapter_path != null) {
            stmt.bindString(2, chapter_path);
        }
        ...
        stmt.bindLong(6, entity.getBookinfo_id());
    ...
    public BookChapterBean readEntity(Cursor cursor, int offset) {
        BookChapterBean entity = new BookChapterBean( //
            ...
            cursor.isNull(offset + 1) ? null : cursor.getString(offset + 1), // chapter_path
            ...
            cursor.getInt(offset + 5), // bookinfo_id
    ...
    public void readEntity(Cursor cursor, BookChapterBean entity, int offset) {
        ...
        entity.setChapter_path(cursor.isNull(offset + 1) ? null : cursor.getString(offset + 1));
        ...
        entity.setBookinfo_id(cursor.getInt(offset + 5));
    ...
    public List<BookChapterBean> _queryCollBookBean_BookChapterList(int bookinfo_id) {
        synchronized (this) {
            if (collBookBean_BookChapterListQuery == null) {
                QueryBuilder<BookChapterBean> queryBuilder = queryBuilder();
                queryBuilder.where(Properties.Bookinfo_id.eq(null));
        ...
        query.setParameter(0, bookinfo_id);
        return query.list();
    }
